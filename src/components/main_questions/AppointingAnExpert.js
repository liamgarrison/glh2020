    ...
    <Box>
      ...
      <Box mb={2}>
        <Typography gutterBottom>
              You man need to appoint a qualified expert to assess the damage, especially when it is serious.  When the damage is minor, an expert may not be needed. In this case, you may be able to use receipts, pictures or videos as evidence.
        </Typography>
        <Typography gutterBottom>
